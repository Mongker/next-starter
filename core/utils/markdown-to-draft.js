...
const DefaultBlockEntities = {
    // Đây là phần markdown mention lưu dạng @[xxx](yyy) --> Mention
    // Bây giờ đang không dùng nữa, vì cái này cần phải sửa vào core của thư viện 'remarkable'
    // ------------------------------------------------------------------------------------------------------------
    ...
    // },
    // // ------------------- NhatPA -----------------------------
    // // Bổ sung thêm dạng MENTION trong markdown với @[...](...)
    ...
    // Đây là phần markdown mention lưu dạng [xxx](@yyy) --> Mention
    // Đang dùng vì đang chạy ổn nhất, tuy không chuẩn
    // ------------------- NhatPA ------------------
    // Viết lại cho trường hợp phân biệt link và mention
    // -----------------------------------------------
    // link_open: function (item) {
    //     return {
    //         type: 'LINK',
...
function parseInline(inlineItem, BlockEntities, BlockStyles) {
    ...
    inlineItem.children.forEach(function (child) {
        ...
        // -------------------------- NhatPA -----------------------
        // Cần viết thêm trường hợp xử lý đặc biêt cho link_open
        // Vì mention đang bị nhận là link
        // option của Remarkable của có trường hợp cho link
        // Không, đã xử lý trong phần option link entity
